...
// Offer types for filtering
export const offerTypes = {
  autopilot: { name: 'Autopilot', icon: '⚙️', description: 'IVA + SS automation' },
  escudo: { name: 'Escudo Fiscal', icon: '🛡️', description: 'Fine protection up to €1,500' },
  free: { name: '0€ Forever', icon: '💎', description: 'Free certified invoicing' },
  whatsapp: { name: 'WhatsApp-first', icon: '💬', description: 'Invoice via chat' }
};

// Emotion types for filtering
export const emotionTypes = {
  calm: { name: 'Calma', nameEn: 'Calm', color: '#4ECDC4' },
  control: { name: 'Controlo', nameEn: 'Control', color: '#45B7D1' },
  protection: { name: 'Proteção', nameEn: 'Protection', color: '#96CEB4' },
  speed: { name: 'Velocidade', nameEn: 'Speed', color: '#FFEAA7' }
};
